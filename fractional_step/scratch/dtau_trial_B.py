...
KAP = (0.01, 0.03, 0.1, 0.3)

print("=" * 108)
print("B. short domain, w_mom = 1.0, from the converged no-pin field")
print("   swept at matched KAPPA (dtau = w_mom/kappa), because kappa is what the")
print("   operator sees.  Case A converged at kappa = 0.1; case B was never tested there.")
print("   undamped: cap at 80, J 1.1229e-03.  with line search: conv 53 it, J 1.122e-03")
print("=" * 108)
U_w1 = np.load(f'{SC}/bfsnp2_off_nopin.npz')['U']
print(HDR)
for kap in KAP:
    show(f'{1.0/kap:.3g}', run(U_w1, 1.0, 1.0/kap))
